...
uses
  System.Classes, System.SysUtils, System.IOUtils, System.Types, System.Math, System.Messaging, FMX.MediaLibrary, 
  FMX.Platform, FMX.Platform.Android, FMX.Controls, FMX.Helpers.Android, FMX.Graphics, FMX.Consts, FMX.Surfaces, 
  FMX.Forms, Androidapi.JNI.GraphicsContentViewText, Androidapi.JNI.App, Androidapi.JNI.JavaTypes,
  Androidapi.JNI.Net, Androidapi.IOUtils, Androidapi.JNIBridge, Androidapi.JNI, Androidapi.Bitmap, Androidapi.JNI.Os,
  Androidapi.JNI.Embarcadero, Androidapi.Helpers, Android.Support.v4;
...
begin
  ...
  FileNameTemp := StringToJString(TPath.Combine(GetCacheDir, 'attachment.png'));
  //TAndroidHelper.Activity.openFileOutput(FileNameTemp, TJContext.JavaClass.MODE_WORLD_READABLE);
  //ImageFile := TAndroidHelper.Activity.getExternalFilesDir(FileNameTemp);
  //ImageUri := TJnet_Uri.JavaClass.fromFile(ImageFile);
  AImage.SaveToFile(JStringToString(FileNameTemp));
  ImageFile := TJFile.JavaClass.init(FileNameTemp);
  ImageUri := TJFileProvider.JavaClass.getUriForFile(TAndroidHelper.Context, StringToJString('com.mydomain.fileprovider'), ImageFile);
